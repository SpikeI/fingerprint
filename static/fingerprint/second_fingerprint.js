(function (name, context, definition) {
  ...
  Fingerprint2.prototype = {
    ...
    get: function (done) {
      ...
      keys = this.userAgentKey(keys) //get ua
      keys = this.languageKey(keys) //get language
  ...
  fp.get(function(result, components) {
    ...
    if(typeof window.console !== "undefined") {
      ...
      for (var index in components) {
        ...
        details[obj.key] = value.toString()
    ...
    console.log("detail");
    console.log(details);
    detect_device_menory = details['device_memory'];
    detect_navigator_platform = details['navigator_platform'];
    detect_color_depth = details['color_depth'];
